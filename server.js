...
// ═════════════════════════════════════════════════════════════
// CATCH-ALL: Return 404 for unknown routes (HTML hosted on InfinityFree)
// ═════════════════════════════════════════════════════════════
app.get('*', (req, res) => {
  res.status(404).json({ success: false, message: 'Endpoint not found. This is the API server.' });
});
